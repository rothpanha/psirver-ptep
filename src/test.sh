...
check_endpoint "GET /jobs/<id>/stdout/" "curl $CURLFLAGS $SERVER/jobs/355/stdout/" "400"
...
check_endpoint "GET /scripts/<id>/delete" "curl $CURLFLAGS $SERVER/scripts/0/delete" "200"
